...
class Page extends Component {
  ...
  render() {
    ...
    return (
      <li
        className={`hawk-pagination__page${(pageNumber === activePage) ? ` ${activePageClassName}` : ''}`}
...
export default class Pagination extends Component {
  ...
  static defaultProps = {
    activePageClassName: 'hawk-pagination__page--selected',
  ...
  render() {
    ...
    return (<ul className={getClassNames('hawk-pagination', className)}>
      {
        activePage >= pageRangeDisplayed && isShowFirstAndLastOption &&
        <span
          className="hawk-pagination__page-first-last"
